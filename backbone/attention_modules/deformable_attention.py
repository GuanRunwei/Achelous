...
if __name__ == '__main__':
    x = torch.randn(1, 672, 10, 10).cuda()
    attn = DeformableAttention2D(dim=672).cuda()
    print(attn(x).shape)  # (1, 512, 64, 64)

    print(summary(attn, input_size=[(1, 672, 10, 10)]))
    macs, params = profile(attn, inputs=[x])
    macs *= 2
