...
def fit_one_epoch(model_train, model, ema, yolo_loss, loss_history, loss_history_seg, eval_callback, eval_callback_seg, eval_callback_seg_w, optimizer, epoch, epoch_step,
                  epoch_step_val, gen, gen_val, Epoch, cuda, fp16, scaler, save_period, save_dir, dice_loss, focal_loss, cls_weights, cls_weights_wl, num_class_seg, local_rank=0):
    total_loss_det = 0
    total_loss_seg = 0
    total_loss_seg_w = 0
    total_f_score = 0
    ...
    for iteration, batch in enumerate(gen):
        ...
        total_loss += total_loss_det + total_loss_seg + total_loss_seg_w
    ...
    for iteration, batch in enumerate(gen_val):
        ...
        val_total_loss = val_loss_det + val_loss_seg + val_loss_seg_w
